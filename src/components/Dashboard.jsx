...
const Dashboard = () => {
  ...
  const loadAllData = async () => {
    ...
    try {
      ...
      try {
        ...
        const videoArray = Array.isArray(vData) ? vData : (vData.data || []);
      ...
      const resourceArray = Array.isArray(rData) ? rData : (rData.data || []);
  ...
  const uploadToCloudinary = async (file) => {
    ...
    // FIXED: Removed space in URL that was causing "Failed to fetch"
    ...
    <>
      ...
      <div style={{minHeight: '100vh', background: COLORS.gray50, fontFamily: 'system-ui, sans-serif'}}>
        ...
        <main style={{maxWidth: '1200px', margin: '0 auto', padding: '40px 20px'}}>
          ...
          {/* COMMUNITY - IMPROVED CARD STYLING */}
          {activeTab === 'community' && (
          ...
          {/* RESOURCES - NOW WITH MODAL POPUP */}
          {activeTab === 'resources' && (
